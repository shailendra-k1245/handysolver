...
export const JobPreview = () => {
    ...
    return <div className="flex flex-col gap-9 mx-9">
        ...
        {jobs.Experience.marked ? <p>Experience: {(jobs.Experience.data.max)+" to "+ (jobs.Experience.data.min)}</p> : ""}
        ...
        {jobs.Labels.marked ? <p>Labels: {(jobs.Labels.data[0] || "") + "," + (jobs.Labels.data[1] || "")}</p> : ""}
